...
#define new_unmasking_arithmetic_to_boolean_highbits DILITHIUM_NAMESPACE(new_unmasking_arithmetic_to_boolean_highbits)
void new_unmasking_arithmetic_to_boolean_highbits(int32_t* pR,const int32_t* pR1,mask_point pD);

#define new_unmasking_arithmetic_to_boolean_lowbits DILITHIUM_NAMESPACE(new_unmasking_arithmetic_to_boolean_lowbits)
void new_unmasking_arithmetic_to_boolean_lowbits(int32_t* pR0,const int32_t* pR,mask_point pD);
